 ...
 */
public class PopDialogTest extends HotelApp_BisinessFunction
{	
	/**
	 * Initial setup
	...
	public void testWebHotelApp() throws Exception  
	{
	    ...
	    new Select(driver.findElement(By.id(prop.getProperty("Lst_BookHotel_CCExpYear")))).selectByVisibleText("2011");
	    ...
	    //code added for pop dialog test 
	    // instance of alert to switch the focus from driver to the alert pop-up
	    Alert javaScriptAlert = driver.switchTo().alert();
	    System.out.println(javaScriptAlert.getText()); //get text on alert(pop up) box
	    javaScriptAlert.accept();
	    
	    HA_GF_WaitForElementPresent(driver, By.id(prop.getProperty("Txt_BookHotel_OrderOn")), 10000);
