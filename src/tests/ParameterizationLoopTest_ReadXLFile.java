 ...
 */
public class ParameterizationLoopTest_ReadXLFile extends HotelApp_BisinessFunction
{	
	/**
	 * Initial setup
...
//				
//		String sDataPoolFolderPath = prop.getProperty("DataPool");
		
		
		String sDataPoolFolderPath = "./DataPool/HA_HotelSearch.xls";
		int intRowCount = HA_GF_XLRowCount(sDataPoolFolderPath, "Location");
		for (int j = 1; j < intRowCount; j++)
		{		
			HA_BF_Login(driver, "RahulShetty", "Start123.");
					
		    //Call to the function HA_GF_readXL
		    String strLocation = HA_GF_readXL(j, "Location", sDataPoolFolderPath);
