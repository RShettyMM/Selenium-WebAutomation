 ...
 */
public class Final_HotelApp_Automation extends HotelApp_BisinessFunction
{	
	/**
	 * Initial setup
	...
	public void testWebHotelApp() throws Exception  
	{
		...
		//TestNG built in class 
		//to add the messages in the HTML report 
		Reporter.log("Login was was successful", true);
